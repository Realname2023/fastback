...
#     #                       web_app=WebAppInfo(url='https://rmatrix.pyscriptapps.com/tgapp/latest/'))],
...
kb_client = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Заказать товары', 
                          web_app=WebAppInfo(url='https://bb1b-62-122-104-14.ngrok-free.app'))],
    [InlineKeyboardButton(text='Адреса контакты', callback_data='addres'),
    InlineKeyboardButton(text='График работы', callback_data='worktime')],
    [InlineKeyboardButton(text='Акции', callback_data='actions'),
     InlineKeyboardButton(text=f'Отзывы\nи ссылки', callback_data='voices')],
...
group_kb = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Заказать товары', url='https://t.me/VTGtestbot')],
    [InlineKeyboardButton(text='Написать оператору', url='https://t.me/VTGonlinebot')]])

web_kb = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text='Сайт', web_app=WebAppInfo(url='https://vostoktehgaz.com/', request_contact=True))]
